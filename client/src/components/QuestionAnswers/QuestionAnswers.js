...
class QuestionAnswers extends Component {
  ...
  render(){
    return(
        <div> {auth.getProfile().type === "prospect" ? <div><Question questions={this.props.questions} /> <br/> <AskQuestion userId={this.props.userId} collegeId={this.props.collegeId}/></div> : <div><Question questions={this.props.questions}/></div>} </div>
